...
public class ActivateTeleportation : MonoBehaviour
{
    ...
    void Update()
    {
        //bool isLeftRayHovering = leftRay.TryGetInfo(out Vector3 leftPos, out Vector3 leftNormal, out int leftNumber, out bool leftValid);
        ...
        //bool isRightRayHovering = rightRay.TryGetInfo(out Vector3 rightPos, out Vector3 rightNormal, out int rightNumber, out bool rightValid);
